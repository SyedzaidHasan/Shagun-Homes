              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <div className="space-y-1 text-muted-foreground">
                    <p>
                      <a href="tel:+919871035001" className="hover:text-primary transition-colors">
                       +91 9871035001
                      </a>
                    </p>
                    <p className="text-sm">Rajiv Tewatiya: <a href="tel:+919871035001" className="hover:text-primary transition-colors">+91 9871035001</a></p>
                    <p className="text-sm">Pramod Katewa: <a href="tel:+917678121555" className="hover:text-primary transition-colors">+91 7678121555</a></p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card rounded-xl p-6 shadow-md">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:info@shagunhomes.in"
