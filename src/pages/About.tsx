          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  Founded by Rajiv Kumar and Pramod Kumar, ShagunHomes was born from a vision to transform the real estate experience in Greater Noida. With deep local knowledge and years of industry expertise, we recognized the need for a more transparent and client-focused approach to property transactions.
                </p>
                <p>
      ...
      <section className="py-16 md:py-20 bg-muted/30">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Let us help you find the perfect property in Greater Noida
          </p>
