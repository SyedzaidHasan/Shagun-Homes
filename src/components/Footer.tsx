        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center gap-2">
                ...
                <div className="space-y-1">
                  <a href="tel:+919871035001" className="hover:text-secondary transition-colors opacity-90 hover:opacity-100 block">
                    +91 9871035001
                  </a>
              ...
              <li className="flex items-center gap-2 opacity-90">
                ...
                <a href="mailto:info@shagunhomes.in" className="hover:text-secondary transition-colors hover:opacity-100">
                  info@shagunhomes.in
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="text-sm space-y-2 opacity-90">
              ...
              <p className="text-xs mt-4">Tuesday: Closed</p>
            </div>
          </div>
        </div>
