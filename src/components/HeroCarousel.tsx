...
const slides = [
  {
    id: 1,
    title: "Find Your Dream Home in Greater Noida",
  ...
  },
  {
    ...
    subtitle: "Discover Premium Apartments & Builder Floors in Greater Noida",
    image: "/Bg-img-1.jpg",
  },
  {
    id: 3,
        ...
        >
          ...
          <div className="relative h-full container mx-auto px-4 md:px-8 flex items-center">
            ...
            >
              ...
              >
                Discover Greater Noida's best properties
              </motion.p>
              <motion.h1
